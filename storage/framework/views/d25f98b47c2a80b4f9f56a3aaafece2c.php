...
<div class="min-h-screen bg-red-800 pb-12" x-data="orderManager">
        ...
        <div class="flex flex-wrap gap-2 justify-center">
            <a href="<?php echo e(route('admin.orders')); ?>" 
               class="px-6 py-2 rounded-full font-['Kalam'] text-white transition-all duration-200 
                      <?php echo e(!request('status') ? 'bg-[#D68C45]' : 'bg-white/20 hover:bg-[#D68C45]/80'); ?>">
                All Orders
            </a>
            <a href="<?php echo e(route('admin.orders.filter', ['status' => 'confirmation'])); ?>" 
               class="px-6 py-2 rounded-full font-['Kalam'] text-white transition-all duration-200 
                      <?php echo e(request('status') === 'confirmation' ? 'bg-[#78A2CC]' : 'bg-white/20 hover:bg-[#78A2CC]/80'); ?>">
                Waiting for Confirmation
            </a>
            <a href="<?php echo e(route('admin.orders.filter', ['status' => 'processing'])); ?>" 
               class="px-6 py-2 rounded-full font-['Kalam'] text-white transition-all duration-200 
                      <?php echo e(request('status') === 'processing' ? 'bg-[#D68C45]' : 'bg-white/20 hover:bg-[#D68C45]/80'); ?>">
                Processing
            </a>
            <a href="<?php echo e(route('admin.orders.filter', ['status' => 'completed'])); ?>" 
               class="px-6 py-2 rounded-full font-['Kalam'] text-white transition-all duration-200 
                      <?php echo e(request('status') === 'completed' ? 'bg-[#90B77D]' : 'bg-white/20 hover:bg-[#90B77D]/80'); ?>">
                Completed
            </a>
            <a href="<?php echo e(route('admin.orders.filter', ['status' => 'rejected'])); ?>" 
               class="px-6 py-2 rounded-full font-['Kalam'] text-white transition-all duration-200 
                      <?php echo e(request('status') === 'rejected' ? 'bg-red-500' : 'bg-white/20 hover:bg-red-500/80'); ?>">
                Rejected
            </a>
        </div>
    </div>
    ...
    <div class="w-full max-w-6xl mx-auto px-3 sm:px-4">
        ...
        <?php if($filteredOrders->count() > 0): ?>
            <div class="orders-carousel relative w-full">
                <div class="carousel-container">
                    <div class="carousel-track">
                        <?php $__currentLoopData = $filteredOrders->chunk(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="w-full">
                                            ...
                                            <div class="bg-white shadow-md relative w-full max-w-md mx-auto transform hover:-translate-y-1 transition-transform duration-200"
                                                ...
                                                @click="deleteMode && handleCardClick($event, '<?php echo e($order->status); ?>', <?php echo e($order->id); ?>)">                                                <!-- Paper lines effect -->
        ...
        <template x-if="deleteMode">
            <div class="relative z-10">
                <input type="checkbox" 
                    ...
                    :disabled="!isOrderDeletable('<?php echo e($order->status); ?>')"
                    @click="handleOrderSelection($event, '<?php echo e($order->status); ?>')">
                <label for="order-<?php echo e($order->id); ?>"
                    class="w-6 h-6 rounded flex items-center justify-center cursor-pointer transition-colors"
                    :class="[
                        selectedOrders.includes('<?php echo e($order->id); ?>') ? 'bg-red-500' : 'bg-gray-200',
                        !isOrderDeletable('<?php echo e($order->status); ?>') ? 'opacity-50 cursor-not-allowed' : ''
                    ]">
                    <svg class="w-4 h-4 text-white" 
                            x-show="selectedOrders.includes(<?php echo e($order->id); ?>)"
            ...
            <?php endswitch; ?>
                                                    ...
                                                    <div class="space-y-3 pl-4">
                                                        ...
                                                        <div class="flex items-center gap-2">
                                                            ...
                                                            <strong><span class="font-['Kalam'] text-gray-900"><?php echo e($order->user->name); ?></span></strong>
                                                        </div>
...
<div class="flex flex-col gap-1">
    ...
    <div class="flex items-center gap-2">
        <div class="flex gap-1 mb-5">
            <?php for($i = 0; $i < min($order->spice_level, 5); $i++): ?>
        ...
        <span class="font-['Kalam'] text-sm">
            ...
            <?php endif; ?>
                                                    ...
                                                    <div class="mt-4 flex justify-end">
                                                        <a href="<?php echo e(route('admin.orders.view', $order)); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mira3\Downloads\seblakFINALLY\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>