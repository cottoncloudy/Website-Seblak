    ...
    <nav class="fixed top-0 left-0 right-0 bg-[#3C1515] z-50 shadow-lg">
        <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
            <div class="flex items-center justify-between h-16 sm:h-20">
                ...
                <div class="flex-shrink-0">
                    <a href="<?php echo e(route('admin.orders')); ?>" class="block">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Seblak Mama DK" 
                ...
                <div class="hidden sm:flex items-center space-x-4">
                    <a href="<?php echo e(route('admin.orders')); ?>" 
                       class="block text-center <?php echo e(request()->routeIs('admin.orders') ? 'bg-[#B05B3B]' : 'hover:bg-[#B05B3B]'); ?> 
                              rounded-xl px-4 py-2 font-['Kalam'] text-base text-white 
                              transition-all duration-200">
                        Orders
                    </a>
                    
                    <a href="<?php echo e(route('admin.toppings.index')); ?>" 
                       class="block text-center <?php echo e(request()->routeIs('admin.toppings.*') ? 'bg-[#B05B3B]' : 'hover:bg-[#B05B3B]'); ?> 
                              rounded-xl px-4 py-2 font-['Kalam'] text-base text-white 
                              transition-all duration-200">
                        Manage Toppings
                    </a>

                    <form action="<?php echo e(route('logout')); ?>" method="POST" class="inline-block" id="logout-form">
                        <?php echo csrf_field(); ?>
                        <a href="#" 
                           ...
                           class="flex items-center text-center bg-[#8C1A1A] hover:bg-[#701414] rounded-xl px-4 py-2 font-['Kalam'] text-base text-white transition-all duration-200">
                            <img src="<?php echo e(asset('images/logout.svg')); ?>" alt="Logout" class="h-5 w-5 mr-1.5">
                            <span>Logout</span>
                        </a>
                    </form>
                </div>
        ...
        <div id="mobile-menu" 
            ...
            <div class="flex flex-col space-y-4 px-4">
                <a href="<?php echo e(route('admin.orders')); ?>" 
                   class="text-center <?php echo e(request()->routeIs('admin.orders') ? 'bg-[#B05B3B]' : 'hover:bg-[#B05B3B]'); ?> 
                ...
                <a href="<?php echo e(route('admin.toppings.index')); ?>" 
                   class="text-center <?php echo e(request()->routeIs('admin.toppings.*') ? 'bg-[#B05B3B]' : 'hover:bg-[#B05B3B]'); ?> 
                          rounded-xl px-4 py-3 font-['Kalam'] text-base text-white 
                          transition-all duration-200">
                    Manage Toppings
                </a>

                <form action="<?php echo e(route('logout')); ?>" method="POST" class="block" id="mobile-logout-form">
                    <?php echo csrf_field(); ?>
                    <a href="#" 
...
</html><?php /**PATH C:\Users\mira3\Downloads\seblakFINALLY\resources\views/layouts/admin.blade.php ENDPATH**/ ?>