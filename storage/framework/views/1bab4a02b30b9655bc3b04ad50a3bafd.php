    ...
    <div class="w-full max-w-[320px] sm:max-w-md" id="paper-card">
        ...
        <div class="relative bg-white shadow-md">
            ...
            <div class="px-8 sm:px-16 py-4 sm:py-6 relative" style="z-index: 3;">
                ...
                <form id="register-form" method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4 sm:space-y-6">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-4 sm:mt-6 w-full max-w-[320px] sm:max-w-md px-4 sm:px-8 opacity-0" id="button-container">
        ...
        <p class="text-center text-white font-['Kalam'] text-sm sm:text-base">
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-yellow-400 hover:text-yellow-300 font-['Kalam']" id="to-login">
                login here
            </a>
        </p>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mira3\Downloads\seblakFINALLY\resources\views/auth/register.blade.php ENDPATH**/ ?>