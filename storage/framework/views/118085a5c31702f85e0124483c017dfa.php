                    ...
                    <div class="flex-none w-40 sm:w-56 snap-start" data-topping-id="<?php echo e($topping->id); ?>">
                        <div class="bg-[#FFE5E5] rounded-2xl overflow-hidden shadow-lg">
                            ...
                            <div class="p-3 sm:p-4">
                                <h4 class="font-['Kalam'] text-lg sm:text-xl text-center mb-2"><?php echo e($topping->name); ?></h4>
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    <button class="w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center hover:bg-red-600 transition-colors"
                                            @click="let currentStock = parseInt($el.parentElement.querySelector('.stock-input').value); updateStock(<?php echo e($topping->id); ?>, currentStock - 1)">−</button>
                                    <input type="number" 
                                           class="stock-input w-16 text-center rounded-full bg-white px-2 py-1"
                                           value="<?php echo e($topping->stock); ?>"
                                           min="0"
                                           @change="updateStock(<?php echo e($topping->id); ?>, parseInt($event.target.value))">
                                ...
                                <div class="flex items-center justify-center mb-3 mt-4">
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               class="sr-only peer"
                                               x-model="toppings[<?php echo e($topping->id); ?>].is_available"
                                               @change="toggleAvailability(<?php echo e($topping->id); ?>, $event.target.checked)">
                                ...
                                <div class="flex justify-center gap-2">
                                    <button @click="editTopping(<?php echo e($topping->id); ?>)"
                                    ...
                                    <button @click="confirmDelete(<?php echo e($topping->id); ?>, '<?php echo e($topping->name); ?>')"
    ...
    <div x-show="showAddModal" 
        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div class="relative bg-white rounded-2xl w-full max-w-md p-6">
                ...
                <form action="<?php echo e(route('admin.toppings.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
                        ...
                        <div>
                            ...
                            <?php if(config('app.debug')): ?>
                                <div class="mt-1 text-xs text-gray-500">
                                    Available categories: <?php echo e($toppingCategories->pluck('name')->join(', ')); ?>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('toppingManager', () => ({
        ...
        deletingToppingName: '',
        toppings: <?php echo json_encode($toppingCategories->pluck('toppings')->flatten()->keyBy('id')->map(function($topping) {
            return [
                'id' => $topping->id, 'stock' => $topping->stock, 'is_available' => $topping->is_available
            ];
        })) ?>,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mira3\Downloads\seblakFINALLY\resources\views/admin/toppings/index.blade.php ENDPATH**/ ?>