            ...
            <div class="bg-[#FFE5E5] rounded-2xl overflow-hidden shadow-lg">
                ...
                <div class="p-6 text-center">
                    <div class="bg-white p-4 rounded-xl inline-block mb-6">
                        <img src="<?php echo e(asset('images/qris.png')); ?>" alt="QR Code Payment" class="max-w-[250px] mx-auto">
                    </div>

                    <!-- Upload Form -->
                    <form action="<?php echo e(route('payment.proof', $order)); ?>" method="POST" enctype="multipart/form-data" id="paymentForm">
                        <?php echo csrf_field(); ?>
                        <div class="space-y-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mira3\Downloads\seblakFINALLY\resources\views/payment/show.blade.php ENDPATH**/ ?>